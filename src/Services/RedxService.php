...
class RedxService
{
    ...
    public function __construct()
    {
        ...
        CheckFraudCustomerHelper::checkRequiredConfig([
            'check_fraud_customer.redx.phone',
            'check_fraud_customer.redx.password',
        ]);

        // Load from config
        $this->phone = config('check_fraud_customer.redx.phone');
        $this->password = config('check_fraud_customer.redx.password');

        CheckFraudCustomerHelper::validatePhoneNumber($this->phone);
    }
    ...
    {
        CheckFraudCustomerHelper::validatePhoneNumber($queryPhone);
